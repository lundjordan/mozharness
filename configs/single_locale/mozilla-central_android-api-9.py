...
MOZILLA_DIR = BRANCH
OBJDIR = "obj-l10n"
EN_US_BINARY_URL = "dev-stage01.srv.releng.scl3.mozilla.com/pub/mozilla.org/mobile/nightly/latest-%s-android-api-9/en-US" % (BRANCH)
...
config = {
    ...
    "mozconfig": "%s/mobile/android/config/mozconfigs/android-api-9/l10n-nightly" % MOZILLA_DIR,
